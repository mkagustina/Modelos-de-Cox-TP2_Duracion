...
#### 3) Edad: 
Resulta de interés ver el riesgo para mujeres que fueron expuestas a la quimioterapia, poseen grado 3 de diferenciación y su tumor es de más de 50mm, en especifico para dos grupos etarios: las menores de 40 años y aquellas entre 50 y 65 años.


$$ \begin{array} {m{2cm} | m{2cm}  m{2cm}}
...
1) El riesgo de tener cáncer de mama en pacientes con grado 3 de diferenciación y un tumor entre 20 y 50 mm es, como minimo, un 16.1% mayor y, como máximo, un 84.2% mayor que ese mismo riesgo para aquellas pacientes con grado 3 de diferenciación y un tumor de 20 mm o menos. Mientras que el riesgo de tener cáncer de mama para pacientes con grado 3 de diferenciación y un tumor de más de 50 mm es, como mínimo, un 69.2% mayor y, como máximo, un 217% mayor que ese mismo riesgo para aquellas pacientes también con grado 3 pero con un tumor de 20mm o menos; todo esto para valores fijos de las variables restantes.

2) 

3) El riesgo de tener cáncer de mama en mujeres entre 50 y 65 años es, al menos, un 9.2% mayor y, como mucho, casi un 150% mayor que ese mismo riesgo en mujeres de menos de 40 años; para los valores establecidos anteriormente de las demás variables.
