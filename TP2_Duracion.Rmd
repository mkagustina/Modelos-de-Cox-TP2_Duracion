...
$$ \begin {array} {c|c|c}
\text{Variable agregada} & \textit{p-value asociado} & Decisión \\
\hline
\text{Tratamiento hormonal} & 0.542 & \text{No rechazo H}_0 \\
\text{Quimioterapia} & 0.021 & \text{Rechazo H}_0 \\
\text{Receptores de progesterona} & 0.381 & \text{No rechazo H}_0 \\
\end {array} $$
...
H_0) \text{El efecto de Edad es lineal} \\
H_1) \text{El efecto de Edad NO es lineal}
