...
#### 1) Grado y Tamaño: 
<<<<<<< HEAD
con la interpretación de los coeficientes del modelo se pudo concluir que el tumor más grave es el de grado 3 y tamaño mayor a 50mm, y el menos grave es el de grado 2 y tamaño menor a 20mm. Para cuantificar la diferencia entre ambos tumores se calcula la razón de hazards para un grupo etario y tratamiento de quimioterapia fijos.
...
IC_inf <- rh-1.96*sqrt(0.119^2+0.159^2+2*(-0.001))
IC_sup <- rh+1.96*sqrt(0.119^2+0.159^2+2*(-0.001))
```
...
# Primer RH
=======
Es sabido que a mayor grado de diferenciciación más rápida es la dispersión del cáncer, por lo que se calcula la razón de hazard para el grado de diferenciación 3 y comparando, por un lado, el tamaño del tumor menor o igual a 20 mm contra el tamaño entre 20 y 50 mm; por otro, el tamaño del tumor menor o igual a 20 mm contra el tamaño mayor a 50 mm.
...
>>>>>>> 6bee6252cb7ee6e366bee45effd3694213caa196
...
IC_inf <- rh-1.96*sqrt(0.158^2+0.159^2+2*(-0.001))
IC_sup <- rh+1.96*sqrt(0.158^2+0.159^2+2*(-0.001))
```
...
$$
\begin{array} {c|c|c}
\hat{RH} & \text{Estimación puntual} & \text{Intervalo} \\
\hline
G=3; \; T \leq 20 \; \text{vs} \; G=2, \; T \geq 50 & 3.155 & (2.776; 3.534) \\
\\
Q=\text{no}, \; T \; >50 \; \text{vs} \; Q=\text{si}, \; T \leq 20 & 3.284 & (1.034; 2.578) \\
\\
Q=\text{no}, \; T \leq 20; \; \text{vs} \; Q=\text{si}, \; T \; >50 & 3.735 & (2.140;5.048) \\
\\
Q=\text{si}; \; G=3; \; T>50; \; E=<40 \; \text{vs} \; \geq50 \;\text{-}<65 & 1.65 & (1.092;2.488) \\
\end{array}
$$

#### 1) 
La tasa de mortalidad de pacientes con grado de diferenciación tumoral 3 y un tumor de más de 50mm de diámetro es, como mínimo un 177% y como máximo un 253% mayor que esa misma tasa para pacientes con grado 2 de diferenciación y un tumor de 20mm de diámetro o menos, para un grupo etario y *Quimioterapia* fijos.
