...
Se utilizará el método de selección de modelos propuesto por Collet.
...
Para cada variable, se compara entonces un modelo aditivo que contenga todas las variables significativas hasta el momento, excepto la variable en cuestión, contra un modelo sí la incluya.
